  ...
  return (
    <div className="sidebar">
      <div className="header">
        <a href="/">
          ...
          >
            ...
            <defs>
              <clipPath id="a">
                <path fill="#fff" d="M0 0h95v28H0z"></path>
              </clipPath>
              <clipPath id="b">
      ...
      <div className="content">
        <ul className="menu">
          <li className="menu-item">
            ...
            >
              ...
              <span className="dark:text-neutral-200">All Notes</span>
              {location.pathname === "/" && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
          ...
          <li className="menu-item">
            <Link
              to="/archives"
              className={`${
                location.pathname === "/archives" ? "sidebar_active" : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="dark:text-neutral-200">Archived Notes</span>
        ...
        <div className="tags_sidebar" bis_skin_checked="1">
          <div className="tags_sidebar_inside" bis_skin_checked="1">
            <p className="mb-2">Tags</p>
            <ul className="space-y-1">
              {tags?.map((tag, index) => (
                <li
                  className={`${tag === link_tag ? "sidebar_active" : ""}`}
                  key={index}
                >
                  <a href={`/?tag=${tag}`}>
                    <svg
